...
public class OVRGrabbable : MonoBehaviour
{
	...
	virtual public void GrabEnd(Vector3 linearVelocity, Vector3 angularVelocity)
    {
        ...
        rb.velocity = linearVelocity * forceMultiplier + Vector3.up * forceMultiplier;
        rb.angularVelocity = angularVelocity * forceMultiplier;

        if (GetComponent<GrenadeHit>() != null)
        {
	        GrenadeHit g = gameObject.GetComponent<GrenadeHit>();
	        g.ActivateGrenade();
        }
        m_grabbedBy = null;
